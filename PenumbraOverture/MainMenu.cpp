...
public:
	...
	void OnMouseDown(eMButton aButton)
	{
		...
		mpInit->mpConfig->SetInt("Screen","Width",mpInit->mvScreenSize.x);
		mpInit->mpConfig->SetInt("Screen","Height",mpInit->mvScreenSize.y);
...
public:
	...
	void OnMouseDown(eMButton aButton)
	{
		...
		mpInit->mpConfig->SetBool("Screen", "Vsync", mpInit->mbVsync);
		mpInit->mpConfig->Save();
	}
};
